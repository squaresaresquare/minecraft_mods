...
public class HalfQuartzPillarEntityRenderer implements BlockEntityRenderer<HalfQuartzPillarEntity, HalfQuartzPillarEntityRenderState> {
    ...
    @Override
    public void updateRenderState(HalfQuartzPillarEntity blockEntity, HalfQuartzPillarEntityRenderState state, float tickProgress,
    ...
    @Override
    public void render(HalfQuartzPillarEntityRenderState state, MatrixStack matrices, OrderedRenderCommandQueue queue, CameraRenderState cameraState) {
        matrices.push();
