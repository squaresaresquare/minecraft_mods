...
Falls du es zu irgendeinem Zeitpunkt benötigst, steht dir ein voll funktionsfähiger Mod mit dem gesamten Quellcode dieser Dokumentation im Ordner [`/reference` auf GitHub](https://github.com/FabricMC/fabric-docs/tree/main/reference/1.21.11) zur Verfügung.
