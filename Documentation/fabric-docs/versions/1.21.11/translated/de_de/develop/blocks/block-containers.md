...
@[code transcludeWith=:::block](@/reference/1.21.11/src/main/java/com/example/docs/block/custom/DuplicatorBlock.java)
...
@[code](@/reference/1.21.11/src/main/java/com/example/docs/container/ImplementedContainer.java)

:::

@[code transcludeWith=:::be](@/reference/1.21.11/src/main/java/com/example/docs/block/entity/custom/DuplicatorBlockEntity.java)
...
@[code transcludeWith=:::save](@/reference/1.21.11/src/main/java/com/example/docs/block/entity/custom/DuplicatorBlockEntity.java)
...
@[code transcludeWith=:::useon](@/reference/1.21.11/src/main/java/com/example/docs/block/custom/DuplicatorBlock.java)
...
@[code transcludeWith=:::tick](@/reference/1.21.11/src/main/java/com/example/docs/block/entity/custom/DuplicatorBlockEntity.java)
...
@[code transcludeWith=:::accept](@/reference/1.21.11/src/main/java/com/example/docs/block/entity/custom/DuplicatorBlockEntity.java)
...
@[code transcludeWith=:::place](@/reference/1.21.11/src/main/java/com/example/docs/block/custom/DuplicatorBlock.java)
