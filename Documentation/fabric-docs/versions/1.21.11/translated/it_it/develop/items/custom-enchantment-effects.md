...
@[code transcludeWith=#entrypoint](@/reference/1.21.11/src/client/java/com/example/docs/datagen/ExampleModEnchantmentGenerator.java)
...
@[code transcludeWith=:::custom-enchantments:register-generator](@/reference/1.21.11/src/client/java/com/example/docs/datagen/ExampleModDataGenerator.java)
