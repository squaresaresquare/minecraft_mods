...
public class TreeNodePosition {
	...
	public TreeNodePosition(
		final AdvancementNode node, @Nullable final TreeNodePosition parent, @Nullable final TreeNodePosition previousSibling, final int childIndex, final int depth
	) {
