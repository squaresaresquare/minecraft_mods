...
public class SpreadPlayersCommand {
	...
	private static double setPlayerPositions(
		...
		int positionIndex = 0;
		Map<Team, SpreadPlayersCommand.Position> teamPositions = Maps.<Team, SpreadPlayersCommand.Position>newHashMap();
		...
		for (Entity entity : entities) {
			...
			if (respectTeams) {
				...
				position = (SpreadPlayersCommand.Position)teamPositions.get(team);
			} else {
