					...
					Commands.argument("target", EntityArgument.entity())
						.then(
							Commands.argument("amount", FloatArgumentType.floatArg(0.0F))
								.executes(
									c -> damage(
										c.getSource(), EntityArgument.getEntity(c, "target"), FloatArgumentType.getFloat(c, "amount"), c.getSource().getLevel().damageSources().generic()
									)
								)
								.then(
													...
													Commands.argument("location", Vec3Argument.vec3())
														.executes(
															c -> damage(
																...
																EntityArgument.getEntity(c, "target"),
																FloatArgumentType.getFloat(c, "amount"),
																new DamageSource(ResourceArgument.getResource(c, "damageType", Registries.DAMAGE_TYPE), Vec3Argument.getVec3(c, "location"))
															)
														)
												)
										)
													...
													Commands.argument("entity", EntityArgument.entity())
														.executes(
															c -> damage(
																...
																EntityArgument.getEntity(c, "target"),
																FloatArgumentType.getFloat(c, "amount"),
																new DamageSource(ResourceArgument.getResource(c, "damageType", Registries.DAMAGE_TYPE), EntityArgument.getEntity(c, "entity"))
															)
														)
														.then(
