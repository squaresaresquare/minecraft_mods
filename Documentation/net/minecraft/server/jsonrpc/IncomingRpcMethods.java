...
public class IncomingRpcMethods {
	...
	private static void registerAllowListService(final Registry<IncomingRpcMethod<?, ?>> methodRegistry) {
		IncomingRpcMethod.<List<PlayerDto>>method(AllowlistService::get)
	...
	private static void registerBanlistService(final Registry<IncomingRpcMethod<?, ?>> methodRegistry) {
		IncomingRpcMethod.<List<BanlistService.UserBanDto>>method(BanlistService::get)
	...
	private static void registerIpBanlistService(final Registry<IncomingRpcMethod<?, ?>> methodRegistry) {
		IncomingRpcMethod.<List<IpBanlistService.IpBanDto>>method(IpBanlistService::get)
	...
	private static void registerPlayerService(final Registry<IncomingRpcMethod<?, ?>> methodRegistry) {
		IncomingRpcMethod.<List<PlayerDto>>method(PlayerService::get)
	...
	private static void registerOperatorService(final Registry<IncomingRpcMethod<?, ?>> methodRegistry) {
		IncomingRpcMethod.<List<OperatorService.OperatorDto>>method(OperatorService::get)
	...
	private static void registerServerStateService(final Registry<IncomingRpcMethod<?, ?>> methodRegistry) {
		IncomingRpcMethod.<ServerStateService.ServerState>method(ServerStateService::status)
	...
	private static void registerServerSettingsService(final Registry<IncomingRpcMethod<?, ?>> methodRegistry) {
		IncomingRpcMethod.<Boolean>method(ServerSettingsService::autosave)
		...
		IncomingRpcMethod.<Difficulty>method(ServerSettingsService::difficulty)
		...
		IncomingRpcMethod.<Boolean>method(ServerSettingsService::enforceAllowlist)
		...
		IncomingRpcMethod.<Boolean>method(ServerSettingsService::usingAllowlist)
		...
		IncomingRpcMethod.<Integer>method(ServerSettingsService::maxPlayers)
		...
		IncomingRpcMethod.<Integer>method(ServerSettingsService::pauseWhenEmpty)
		...
		IncomingRpcMethod.<Integer>method(ServerSettingsService::playerIdleTimeout)
		...
		IncomingRpcMethod.<Boolean>method(ServerSettingsService::allowFlight)
		...
		IncomingRpcMethod.<String>method(ServerSettingsService::motd)
		...
		IncomingRpcMethod.<Integer>method(ServerSettingsService::spawnProtection)
		...
		IncomingRpcMethod.<Boolean>method(ServerSettingsService::forceGameMode)
		...
		IncomingRpcMethod.<GameType>method(ServerSettingsService::gameMode)
		...
		IncomingRpcMethod.<Integer>method(ServerSettingsService::viewDistance)
		...
		IncomingRpcMethod.<Integer>method(ServerSettingsService::simulationDistance)
		...
		IncomingRpcMethod.<Boolean>method(ServerSettingsService::acceptTransfers)
		...
		IncomingRpcMethod.<Integer>method(ServerSettingsService::statusHeartbeatInterval)
		...
		IncomingRpcMethod.<PermissionLevel>method(ServerSettingsService::operatorUserPermissionLevel)
		...
		IncomingRpcMethod.<Boolean>method(ServerSettingsService::hidesOnlinePlayers)
		...
		IncomingRpcMethod.<Boolean>method(ServerSettingsService::repliesToStatus)
		...
		IncomingRpcMethod.<Integer>method(ServerSettingsService::entityBroadcastRangePercentage)
	...
	private static void registerGameRuleService(final Registry<IncomingRpcMethod<?, ?>> methodRegistry) {
		IncomingRpcMethod.<List<GameRulesService.GameRuleUpdate<?>>>method(GameRulesService::get)
