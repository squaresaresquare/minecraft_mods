...
public class ServerFunctionLibrary implements PreparableReloadListener {
	...
	public List<CommandFunction<CommandSourceStack>> getTag(final Identifier tag) {
		return (List<CommandFunction<CommandSourceStack>>)this.tags.getOrDefault(tag, List.of());
	}
	...
	public CompletableFuture<Void> reload(
		...
		CompletableFuture<Map<Identifier, CompletableFuture<CommandFunction<CommandSourceStack>>>> functions = CompletableFuture.supplyAsync(
				() -> LISTER.listMatchingResources(manager), taskExecutor
			)
			.thenCompose(
				functionsToLoad -> {
					Map<Identifier, CompletableFuture<CommandFunction<CommandSourceStack>>> result = Maps.<Identifier, CompletableFuture<CommandFunction<CommandSourceStack>>>newHashMap();
