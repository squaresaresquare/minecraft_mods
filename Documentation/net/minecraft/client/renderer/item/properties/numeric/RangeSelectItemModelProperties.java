...
public class RangeSelectItemModelProperties {
	 ...
	 * Access widened by fabric-transitive-access-wideners-v1 to accessible
	 */
	public static final ExtraCodecs.LateBoundIdMapper<Identifier, MapCodec<? extends RangeSelectItemModelProperty>> ID_MAPPER = new ExtraCodecs.LateBoundIdMapper<>();
