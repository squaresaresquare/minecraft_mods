...
public class SpriteContents implements AutoCloseable, Stitcher.Entry {
	...
	public void increaseMipLevel(final int mipLevel) {
		try {
			...
			frameCategory.setDetail("Sprite size", (CrashReportDetail<String>)(() -> this.width + " x " + this.height));
			frameCategory.setDetail("Sprite frames", (CrashReportDetail<String>)(() -> this.getFrameCount() + " frames"));
			frameCategory.setDetail("Mipmap levels", mipLevel);
			frameCategory.setDetail("Original image size", (CrashReportDetail<String>)(() -> this.originalImage.getWidth() + "x" + this.originalImage.getHeight()));
