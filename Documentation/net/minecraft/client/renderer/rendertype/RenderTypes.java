...
public class RenderTypes {
	static final BiFunction<Identifier, Boolean, RenderType> OUTLINE = Util.memoize(
		(BiFunction<Identifier, Boolean, RenderType>)((texture, cullState) -> RenderType.create(
			"outline",
	...
	private static final BiFunction<Identifier, Boolean, RenderType> ENTITY_CUTOUT = Util.memoize(
		(BiFunction<Identifier, Boolean, RenderType>)((texture, affectsOutline) -> {
	...
	private static final BiFunction<Identifier, Identifier, RenderType> ENTITY_CUTOUT_DISSOLVE = Util.memoize(
		(BiFunction<Identifier, Identifier, RenderType>)((texture, maskTexture) -> {
	...
	private static final BiFunction<Identifier, Boolean, RenderType> BEACON_BEAM = Util.memoize(
		(BiFunction<Identifier, Boolean, RenderType>)((texture, translucent) -> {
	...
	private static final Function<Identifier, RenderType> BANNER_PATTERN = Util.memoize((Function<Identifier, RenderType>)(texture -> {
	...
	private static final Function<Identifier, RenderType> EYES = Util.memoize(
		(Function<Identifier, RenderType>)(texture -> RenderType.create(
			"eyes", RenderSetup.builder(RenderPipelines.EYES).withTexture("Sampler0", texture).sortOnUpload().createRenderSetup()
		))
	);
