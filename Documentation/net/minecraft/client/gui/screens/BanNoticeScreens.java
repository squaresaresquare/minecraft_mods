...
public class BanNoticeScreens {
	...
	private static Component getBannedScreenText(final BanDetails multiplayerBanned) {
		return Component.translatable(
			"gui.banned.description", getBanReasonText(multiplayerBanned), getBanStatusText(multiplayerBanned), Component.translationArg(CommonLinks.SUSPENSION_HELP)
		);
	}
	...
	private static Component getBanStatusText(final BanDetails multiplayerBanned) {
		if (isTemporaryBan(multiplayerBanned)) {
			...
			return Component.translatable(
				"gui.banned.description.temporary", Component.translatable("gui.banned.description.temporary.duration", banDurationText).withStyle(ChatFormatting.BOLD)
			);
		} else {
