...
public class SoundEvents {
	...
	private static Map<ChickenSoundVariants.SoundSet, ChickenSoundVariant> registerChickenSoundVariants() {
		return (Map<ChickenSoundVariants.SoundSet, ChickenSoundVariant>)Stream.of(ChickenSoundVariants.SoundSet.values())
			.collect(
				Collectors.toMap(
					soundSet -> soundSet,
					soundSet -> {
	...
	private static Map<CowSoundVariants.SoundSet, CowSoundVariant> registerCowSoundVariants() {
		return (Map<CowSoundVariants.SoundSet, CowSoundVariant>)Stream.of(CowSoundVariants.SoundSet.values())
			.collect(
				Collectors.toMap(
					soundSet -> soundSet,
					soundSet -> {
	...
	private static Map<PigSoundVariants.SoundSet, PigSoundVariant> registerPigSoundVariants() {
		return (Map<PigSoundVariants.SoundSet, PigSoundVariant>)Stream.of(PigSoundVariants.SoundSet.values())
			.collect(
				Collectors.toMap(
					soundSet -> soundSet,
					soundSet -> {
	...
	private static Map<CatSoundVariants.SoundSet, CatSoundVariant> registerCatSoundVariants() {
		return (Map<CatSoundVariants.SoundSet, CatSoundVariant>)Stream.of(CatSoundVariants.SoundSet.values())
			.collect(
				Collectors.toMap(
					soundSet -> soundSet,
					soundSet -> {
