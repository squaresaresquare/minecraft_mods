...
public class MapDecorationTypes {
	...
	private static Holder<MapDecorationType> register(
		final String name, final String assetName, final boolean showOnItemFrame, final int mapColor, final boolean trackCount, final boolean explorationMapElement
	) {
