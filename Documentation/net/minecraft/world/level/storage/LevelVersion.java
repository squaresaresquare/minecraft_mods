...
public class LevelVersion {
	...
	private LevelVersion(
		final int levelDataVersion, final long lastPlayed, final String minecraftVersionName, final int minecraftVersion, final String series, final boolean snapshot
	) {
