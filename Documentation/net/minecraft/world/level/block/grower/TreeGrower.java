...
public final class TreeGrower {
	...
	private ResourceKey<ConfiguredFeature<?, ?>> getConfiguredFeature(final RandomSource random, final boolean hasFlowers) {
		...
		return hasFlowers && this.flowers.isPresent() ? (ResourceKey)this.flowers.get() : (ResourceKey)this.tree.orElse(null);
	}
	...
	public boolean growTree(final ServerLevel level, final ChunkGenerator generator, final BlockPos pos, final BlockState state, final RandomSource random) {
		...
		if (megaFeatureKey != null) {
			Holder<ConfiguredFeature<?, ?>> featureHolder = (Holder<ConfiguredFeature<?, ?>>)level.registryAccess()
	...
	public OptionalInt getMinimumHeight(final ServerLevel level) {
		ResourceKey<ConfiguredFeature<?, ?>> featureKey = (ResourceKey<ConfiguredFeature<?, ?>>)this.tree.orElse(null);
		if (featureKey == null) {
