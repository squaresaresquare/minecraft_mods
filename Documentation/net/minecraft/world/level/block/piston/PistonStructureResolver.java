...
public class PistonStructureResolver {
	...
	private void reorderListAtCollision(final int blocksAdded, final int collisionPos) {
		List<BlockPos> head = Lists.<BlockPos>newArrayList();
		List<BlockPos> lastLineAdded = Lists.<BlockPos>newArrayList();
		List<BlockPos> collisionToLine = Lists.<BlockPos>newArrayList();
