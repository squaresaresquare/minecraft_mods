...
public class FlatLevelGeneratorPresets {
	...
	private static class Bootstrap {
		...
		private void register(
			...
			HolderSet.Direct<StructureSet> structuresHolder = HolderSet.direct(
				(List<? extends Holder<StructureSet>>)structures.stream().map(structureSets::getOrThrow).collect(Collectors.toList())
			);
