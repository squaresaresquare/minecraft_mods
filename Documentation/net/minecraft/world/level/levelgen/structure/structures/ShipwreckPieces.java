...
public class ShipwreckPieces {
	...
	public static class ShipwreckPiece extends TemplateStructurePiece {
		...
		public ShipwreckPiece(final StructureTemplateManager structureTemplateManager, final CompoundTag tag) {
			super(
				StructurePieceType.SHIPWRECK_PIECE, tag, structureTemplateManager, location -> makeSettings((Rotation)tag.read("Rot", Rotation.LEGACY_CODEC).orElseThrow())
			);
		...
		protected void handleDataMarker(
			...
			ResourceKey<LootTable> lootTable = (ResourceKey<LootTable>)ShipwreckPieces.MARKERS_TO_LOOT.get(markerId);
			if (lootTable != null) {
