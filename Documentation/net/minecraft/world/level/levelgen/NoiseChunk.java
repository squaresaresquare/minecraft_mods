...
public class NoiseChunk implements DensityFunction.FunctionContext, DensityFunction.ContextProvider {
	...
	public NoiseChunk(
		...
		builder.add((NoiseChunk.BlockStateFiller)context -> this.aquifer.computeSubstance(context, fullNoiseValue.compute(context)));
		...
		this.blockStateRule = new MaterialRuleList((NoiseChunk.BlockStateFiller[])builder.toArray(new NoiseChunk.BlockStateFiller[0]));
	}
