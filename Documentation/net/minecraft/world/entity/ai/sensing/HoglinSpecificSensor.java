...
public class HoglinSpecificSensor extends Sensor<Hoglin> {
	...
	protected void doTick(final ServerLevel level, final Hoglin body) {
		...
		List<Hoglin> adultHoglins = Lists.<Hoglin>newArrayList();
		NearestVisibleLivingEntities visibleLivingEntities = (NearestVisibleLivingEntities)brain.getMemory(MemoryModuleType.NEAREST_VISIBLE_LIVING_ENTITIES)
