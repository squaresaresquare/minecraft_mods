		...
		if (this.isDeadOrDying()) {
			...
			if (this.isNoAi()) {
				...
				if (this.level() instanceof ServerLevel serverLevelx && this.hurtTime == 0) {
					this.knockBack(
						serverLevelx,
						serverLevelx.getEntities(this, this.wing1.getBoundingBox().inflate(4.0, 2.0, 4.0).move(0.0, -2.0, 0.0), EntitySelector.NO_CREATIVE_OR_SPECTATOR)
					);
					this.knockBack(
						serverLevelx,
						serverLevelx.getEntities(this, this.wing2.getBoundingBox().inflate(4.0, 2.0, 4.0).move(0.0, -2.0, 0.0), EntitySelector.NO_CREATIVE_OR_SPECTATOR)
					);
