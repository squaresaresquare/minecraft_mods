...
public class VillagerTrades {
	...
	public static Holder<VillagerTrade> bootstrap(final BootstrapContext<VillagerTrade> context) {
		...
		for (Pair<ResourceKey<VillagerTrade>, Item> pair : List.of(
			...
			context.register(
				pair.getLeft(), new VillagerTrade(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate(pair.getRight(), 8), 4, 1, 0.05F, Optional.empty(), List.of())
			);
		}
		...
		for (Pair<ResourceKey<VillagerTrade>, Item> entry : List.of(
			...
			context.register(
				entry.getLeft(), new VillagerTrade(new TradeCost(Items.EMERALD, 3), new ItemStackTemplate(entry.getRight()), 8, 1, 0.05F, Optional.empty(), List.of())
			);
		}
	...
	private static void registerWanderingTraderFlowers(final BootstrapContext<VillagerTrade> context) {
		...
		for (Pair<ResourceKey<VillagerTrade>, Item> entry : List.of(
			...
			context.register(
				entry.getLeft(), new VillagerTrade(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate(entry.getRight()), 12, 1, 0.05F, Optional.empty(), List.of())
			);
		}
	...
	private static void registerWanderingTraderSaplings(final BootstrapContext<VillagerTrade> context) {
		for (Pair<ResourceKey<VillagerTrade>, Item> entry : List.of(
			...
			context.register(
				entry.getLeft(), new VillagerTrade(new TradeCost(Items.EMERALD, 5), new ItemStackTemplate(entry.getRight()), 8, 1, 0.05F, Optional.empty(), List.of())
			);
		}
	}
	...
	private static void registerWanderingTraderDyes(final BootstrapContext<VillagerTrade> context) {
		for (Pair<ResourceKey<VillagerTrade>, Item> entry : List.of(
			...
			context.register(
				entry.getLeft(), new VillagerTrade(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate(entry.getRight(), 3), 12, 1, 0.05F, Optional.empty(), List.of())
			);
		}
	}
