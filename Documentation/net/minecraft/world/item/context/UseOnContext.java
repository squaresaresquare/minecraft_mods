...
public class UseOnContext {
	 ...
	 * Access widened by fabric-transitive-access-wideners-v1 to accessible
	 */
	public UseOnContext(final Level level, @Nullable final Player player, final InteractionHand hand, final ItemStack itemStack, final BlockHitResult hitResult) {
		this.player = player;
		this.hand = hand;
