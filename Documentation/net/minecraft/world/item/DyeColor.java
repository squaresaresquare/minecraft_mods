...
public enum DyeColor implements StringRepresentable {
	...
	private static final IntFunction<DyeColor> BY_ID = ByIdMap.continuous(
		DyeColor::getId, (DyeColor[])VALUES.toArray(DyeColor[]::new), ByIdMap.OutOfBoundsStrategy.ZERO
	);
	private static final Int2ObjectOpenHashMap<DyeColor> BY_FIREWORK_COLOR = new Int2ObjectOpenHashMap<>(
		(Map<? extends Integer, ? extends DyeColor>)VALUES.stream().collect(Collectors.toMap(v -> v.fireworkColor, v -> v))
	);
