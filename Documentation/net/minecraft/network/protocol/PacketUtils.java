...
public class PacketUtils {
	...
	public static <T extends PacketListener> void fillCrashReport(final CrashReport report, final T listener, @Nullable final Packet<T> packet) {
		if (packet != null) {
			...
			details.setDetail("Type", (CrashReportDetail<String>)(() -> packet.type().toString()));
			details.setDetail("Is Terminal", (CrashReportDetail<String>)(() -> Boolean.toString(packet.isTerminal())));
			details.setDetail("Is Skippable", (CrashReportDetail<String>)(() -> Boolean.toString(packet.isSkippable())));
		}
