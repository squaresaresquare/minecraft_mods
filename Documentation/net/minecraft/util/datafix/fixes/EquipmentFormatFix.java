			...
			return this.fixTypeEverywhere(
				...
				ops -> {
					Predicate<ItemStackOld> isPlaceholder = itemStack -> {
						Typed<ItemStackOld> typed = new Typed<>(oldItemStackType, ops, (ItemStackOld)itemStack);
					...
					return namedOldEquipment -> {
						...
						return areAllEmpty(body, saddle, feet, legs, chest, head, mainhand, offhand)
							...
							: Pair.of(
								typeName,
								Either.left(
									Pair.of(mainhand, Pair.of(offhand, Pair.of(feet, Pair.of(legs, Pair.of(chest, Pair.of(head, Pair.of(body, Pair.of(saddle, new Dynamic(ops)))))))))
								)
							);
					};
				}
