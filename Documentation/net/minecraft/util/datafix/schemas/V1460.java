...
public class V1460 extends NamespacedSchema {
	...
	public Map<String, Supplier<TypeTemplate>> registerEntities(final Schema schema) {
		...
		schema.register(map, "minecraft:area_effect_cloud", (Function<String, TypeTemplate>)(name -> DSL.optionalFields("Particle", References.PARTICLE.in(schema))));
		registerMob(schema, map, "minecraft:armor_stand");
		schema.register(map, "minecraft:arrow", (Function<String, TypeTemplate>)(name -> DSL.optionalFields("inBlockState", References.BLOCK_STATE.in(schema))));
		...
		schema.register(
			map, "minecraft:enderman", (Function<String, TypeTemplate>)(name -> DSL.optionalFields("carriedBlockState", References.BLOCK_STATE.in(schema)))
		);
		...
		schema.register(
			map, "minecraft:fireworks_rocket", (Function<String, TypeTemplate>)(name -> DSL.optionalFields("FireworksItem", References.ITEM_STACK.in(schema)))
		);
		schema.register(
			map, "minecraft:furnace_minecart", (Function<String, TypeTemplate>)(name -> DSL.optionalFields("DisplayState", References.BLOCK_STATE.in(schema)))
		);
		...
		schema.register(
			map,
			"minecraft:horse",
			(Function<String, TypeTemplate>)(name -> DSL.optionalFields("ArmorItem", References.ITEM_STACK.in(schema), "SaddleItem", References.ITEM_STACK.in(schema)))
		);
		registerMob(schema, map, "minecraft:husk");
		registerMob(schema, map, "minecraft:illusion_illager");
		schema.register(map, "minecraft:item", (Function<String, TypeTemplate>)(name -> DSL.optionalFields("Item", References.ITEM_STACK.in(schema))));
		schema.register(map, "minecraft:item_frame", (Function<String, TypeTemplate>)(name -> DSL.optionalFields("Item", References.ITEM_STACK.in(schema))));
		...
		schema.register(map, "minecraft:minecart", (Function<String, TypeTemplate>)(name -> DSL.optionalFields("DisplayState", References.BLOCK_STATE.in(schema))));
		...
		schema.register(map, "minecraft:potion", (Function<String, TypeTemplate>)(name -> DSL.optionalFields("Potion", References.ITEM_STACK.in(schema))));
		...
		schema.register(map, "minecraft:skeleton_horse", (Function<String, TypeTemplate>)(name -> DSL.optionalFields("SaddleItem", References.ITEM_STACK.in(schema))));
		...
		schema.register(
			...
			(Function<String, TypeTemplate>)(name -> DSL.optionalFields("DisplayState", References.BLOCK_STATE.in(schema), References.UNTAGGED_SPAWNER.in(schema)))
		);
		schema.register(
			map, "minecraft:spectral_arrow", (Function<String, TypeTemplate>)(name -> DSL.optionalFields("inBlockState", References.BLOCK_STATE.in(schema)))
		);
		...
		schema.register(
			map, "minecraft:tnt_minecart", (Function<String, TypeTemplate>)(name -> DSL.optionalFields("DisplayState", References.BLOCK_STATE.in(schema)))
		);
		...
		schema.register(map, "minecraft:zombie_horse", (Function<String, TypeTemplate>)(name -> DSL.optionalFields("SaddleItem", References.ITEM_STACK.in(schema))));
	...
	public Map<String, Supplier<TypeTemplate>> registerBlockEntities(final Schema schema) {
		...
		schema.register(map, "minecraft:jukebox", (Function<String, TypeTemplate>)(name -> DSL.optionalFields("RecordItem", References.ITEM_STACK.in(schema))));
		...
		schema.register(map, "minecraft:mob_spawner", (Function<String, TypeTemplate>)(name -> References.UNTAGGED_SPAWNER.in(schema)));
		schema.register(map, "minecraft:piston", (Function<String, TypeTemplate>)(name -> DSL.optionalFields("blockState", References.BLOCK_STATE.in(schema))));
		...
		schema.registerType(
			...
			() -> DSL.optionalFields(
				...
				DSL.optionalFields(
					...
					Pair.of("minecraft:crafted", (TypeTemplate)itemStats.get()),
					Pair.of("minecraft:used", (TypeTemplate)itemStats.get()),
					Pair.of("minecraft:broken", (TypeTemplate)itemStats.get()),
					Pair.of("minecraft:picked_up", (TypeTemplate)itemStats.get()),
					Pair.of("minecraft:dropped", (TypeTemplate)itemStats.get()),
