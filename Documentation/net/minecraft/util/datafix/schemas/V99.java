...
public class V99 extends Schema {
	...
	private static final Map<String, String> ITEM_TO_BLOCKENTITY = DataFixUtils.make(Maps.<String, String>newHashMap(), map -> {
	...
	protected static void registerMinecart(final Schema schema, final Map<String, Supplier<TypeTemplate>> map, final String name) {
		schema.register(map, name, (Supplier<TypeTemplate>)(() -> DSL.optionalFields("DisplayTile", References.BLOCK_NAME.in(schema))));
	}
	...
	public Map<String, Supplier<TypeTemplate>> registerEntities(final Schema schema) {
		...
		schema.register(map, "Item", (Function<String, TypeTemplate>)(name -> DSL.optionalFields("Item", References.ITEM_STACK.in(schema))));
		...
		schema.register(map, "Arrow", (Function<String, TypeTemplate>)(name -> DSL.optionalFields("inTile", References.BLOCK_NAME.in(schema))));
		schema.register(map, "TippedArrow", (Function<String, TypeTemplate>)(name -> DSL.optionalFields("inTile", References.BLOCK_NAME.in(schema))));
		schema.register(map, "SpectralArrow", (Function<String, TypeTemplate>)(name -> DSL.optionalFields("inTile", References.BLOCK_NAME.in(schema))));
		...
		schema.register(
			map,
			"ThrownPotion",
			(Function<String, TypeTemplate>)(name -> DSL.optionalFields("inTile", References.BLOCK_NAME.in(schema), "Potion", References.ITEM_STACK.in(schema)))
		);
		registerThrowableProjectile(schema, map, "ThrownExpBottle");
		schema.register(map, "ItemFrame", (Function<String, TypeTemplate>)(name -> DSL.optionalFields("Item", References.ITEM_STACK.in(schema))));
		...
		schema.register(map, "FireworksRocketEntity", (Function<String, TypeTemplate>)(name -> DSL.optionalFields("FireworksItem", References.ITEM_STACK.in(schema))));
		...
		schema.register(map, "Enderman", (Function<String, TypeTemplate>)(name -> DSL.optionalFields("carried", References.BLOCK_NAME.in(schema))));
		...
		schema.register(map, "AreaEffectCloud", (Function<String, TypeTemplate>)(name -> DSL.optionalFields("Particle", References.PARTICLE.in(schema))));
	...
	public Map<String, Supplier<TypeTemplate>> registerBlockEntities(final Schema schema) {
		...
		schema.register(map, "RecordPlayer", (Function<String, TypeTemplate>)(name -> DSL.optionalFields("RecordItem", References.ITEM_STACK.in(schema))));
		...
		schema.register(map, "MobSpawner", (Function<String, TypeTemplate>)(name -> References.UNTAGGED_SPAWNER.in(schema)));
		...
		schema.register(
			map,
			"FlowerPot",
			(Function<String, TypeTemplate>)(name -> DSL.optionalFields("Item", DSL.or(DSL.constType(DSL.intType()), References.ITEM_NAME.in(schema))))
		);
