...
public class TradeRebalanceTradeTagsProvider extends KeyTagProvider<VillagerTrade> {
	...
	protected void addTags(final HolderLookup.Provider registries) {
		...
		this.tag(VillagerTradeTags.ARMORER_LEVEL_1, true).add(VillagerTrades.COMMON_SMITH_1_COAL_EMERALD, TradeRebalanceVillagerTrades.ARMORER_1_IRON_INGOT_EMERALD);
