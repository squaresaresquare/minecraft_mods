...
public class PackOutput {
	...
	public static class PathProvider {
		...
		public Path file(final Identifier element, final String extension) {
			return element.withPath((UnaryOperator<String>)(path -> this.kind + "/" + path + "." + extension)).resolveAgainst(this.root);
		}

		public Path json(final Identifier element) {
			return element.withPath((UnaryOperator<String>)(path -> this.kind + "/" + path + ".json")).resolveAgainst(this.root);
		}
