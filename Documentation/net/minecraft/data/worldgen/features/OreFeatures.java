...
public class OreFeatures {
	...
	public static void bootstrap(final BootstrapContext<ConfiguredFeature<?, ?>> context) {
		...
		FeatureUtils.register(
			context, ORE_ANCIENT_DEBRIS_LARGE, Feature.SCATTERED_ORE, new OreConfiguration(netherOreReplaceables, Blocks.ANCIENT_DEBRIS.defaultBlockState(), 3, 1.0F)
		);
		FeatureUtils.register(
			context, ORE_ANCIENT_DEBRIS_SMALL, Feature.SCATTERED_ORE, new OreConfiguration(netherOreReplaceables, Blocks.ANCIENT_DEBRIS.defaultBlockState(), 2, 1.0F)
		);
