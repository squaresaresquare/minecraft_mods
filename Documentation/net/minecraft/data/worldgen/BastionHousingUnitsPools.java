...
public class BastionHousingUnitsPools {
	public static void bootstrap(final BootstrapContext<StructureTemplatePool> context) {
		...
		Pools.register(
			...
			new StructureTemplatePool(
				empty, ImmutableList.of(Pair.of(StructurePoolElement.single("bastion/units/stages/rot/stage_1_0", housing), 1)), StructureTemplatePool.Projection.RIGID
			)
		);
		Pools.register(
			context,
		...
		Pools.register(
			...
			new StructureTemplatePool(
				empty, ImmutableList.of(Pair.of(StructurePoolElement.single("bastion/units/wall_units/unit_0", housing), 1)), StructureTemplatePool.Projection.RIGID
			)
		);
		Pools.register(
			context,
			...
			new StructureTemplatePool(
				empty, ImmutableList.of(Pair.of(StructurePoolElement.single("bastion/units/wall_units/edge_0_large", housing), 1)), StructureTemplatePool.Projection.RIGID
			)
		);
		Pools.register(
			context,
		...
		Pools.register(
			...
			new StructureTemplatePool(
				empty, ImmutableList.of(Pair.of(StructurePoolElement.single("bastion/units/ramparts/ramparts_0", housing), 1)), StructureTemplatePool.Projection.RIGID
			)
		);
		Pools.register(
			context,
			...
			new StructureTemplatePool(
				empty, ImmutableList.of(Pair.of(StructurePoolElement.single("bastion/units/rampart_plates/plate_0", housing), 1)), StructureTemplatePool.Projection.RIGID
			)
		);
	}
}
