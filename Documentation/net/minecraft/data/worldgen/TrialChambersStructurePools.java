...
public class TrialChambersStructurePools {
	...
	public static void bootstrap(final BootstrapContext<StructureTemplatePool> context) {
		...
		Pools.register(
			...
			new StructureTemplatePool(empty, List.of(Pair.of(StructurePoolElement.single("trial_chambers/decor/disposal"), 1)), StructureTemplatePool.Projection.RIGID)
		);
		Pools.register(
			context,
		...
		Pools.register(
			...
			new StructureTemplatePool(empty, List.of(Pair.of(StructurePoolElement.single("trial_chambers/reward/vault"), 1)), StructureTemplatePool.Projection.RIGID)
		);
		Pools.register(
			context,
		...
		Pools.register(
			...
			new StructureTemplatePool(empty, List.of(Pair.of(StructurePoolElement.single("trial_chambers/chests/supply"), 1)), StructureTemplatePool.Projection.RIGID)
		);
		Pools.register(
			context,
