...
public class OrePlacements {
	...
	public static void bootstrap(final BootstrapContext<PlacedFeature> context) {
		...
		PlacementUtils.register(
			context, ORE_GRAVEL_NETHER, oreGravelNether, commonOrePlacement(2, HeightRangePlacement.uniform(VerticalAnchor.absolute(5), VerticalAnchor.absolute(41)))
		);
		PlacementUtils.register(
		...
		PlacementUtils.register(
			context, ORE_COAL_LOWER, oreCoalBuried, commonOrePlacement(20, HeightRangePlacement.triangle(VerticalAnchor.absolute(0), VerticalAnchor.absolute(192)))
		);
		PlacementUtils.register(
		...
		PlacementUtils.register(
			context, ORE_DIAMOND, oreDiamondSmall, commonOrePlacement(7, HeightRangePlacement.triangle(VerticalAnchor.aboveBottom(-80), VerticalAnchor.aboveBottom(80)))
		);
		PlacementUtils.register(
			context,
			ORE_DIAMOND_MEDIUM,
		...
		PlacementUtils.register(
			context, ORE_COPPER, oreCoppperSmall, commonOrePlacement(16, HeightRangePlacement.triangle(VerticalAnchor.absolute(-16), VerticalAnchor.absolute(112)))
		);
		PlacementUtils.register(
			context, ORE_COPPER_LARGE, oreCopperLarge, commonOrePlacement(16, HeightRangePlacement.triangle(VerticalAnchor.absolute(-16), VerticalAnchor.absolute(112)))
		);
