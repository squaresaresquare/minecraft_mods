	...
	public void generate() {
		...
		LootData.WOOL_ITEM_BY_DYE
			.forEach(
				(dye, wool) -> this.add(
					EntityType.SHEEP,
					(ResourceKey<LootTable>)BuiltInLootTables.SHEEP_BY_DYE.get(dye),
			...
			LootTable.lootTable()
				.withPool(
					LootPool.lootPool()
						...
						.add(LootItem.lootTableItem(Items.SLIME_BALL).apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0F))).when(this.killedByFrog(entityTypes)))
						.when(
							LootItemEntityPropertyCondition.hasProperties(
