								...
								LootItem.lootTableItem(block)
									.apply(
										...
										count -> SetItemCountFunction.setCount(ConstantValue.exactly(count.intValue()))
											.when(
												LootItemBlockStatePropertyCondition.hasBlockStateProperties(block)
													.setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(SeaPickleBlock.PICKLES, count))
											)
									)
							)
						)
							...
							AlternativesEntry.alternatives(
								AlternativesEntry.alternatives(
										...
										layers -> LootItem.lootTableItem(Items.SNOWBALL)
											.when(
												LootItemBlockStatePropertyCondition.hasBlockStateProperties(block)
													.setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(SnowLayerBlock.LAYERS, layers))
											)
							...
							AlternativesEntry.alternatives(
								...
								age -> {
									...
									LootItemBlockStatePropertyCondition.Builder isAge = LootItemBlockStatePropertyCondition.hasBlockStateProperties(Blocks.PITCHER_CROP)
										.setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(PitcherCropBlock.AGE, age));
									return age == 4
