...
public class ModRecipeProvider extends FabricRecipeProvider {
    ...
    createShapeless(RecipeCategory.MISC, ModBlocks.TWIN_COLUMNS, 9)
            ...
            .offerTo(exporter);
                ...
                offerReversibleCompactingRecipes(RecipeCategory.BUILDING_BLOCKS, ModBlocks.QUARTZ_PILLAR, RecipeCategory.DECORATIONS, ModBlocks.QUARTZ_PILLAR);
    createShaped(RecipeCategory.MISC, ModBlocks.QUARTZ_PILLAR)
            .pattern("XXX")
            .pattern("XXX")
            .pattern("XXX")
            .input('Q', ModBlocks.QUARTZ_PILLAR)
    ...
    createShapeless(RecipeCategory.MISC, ModBlocks.HALF_QUARTZ_PILLAR, 9)
            .input(ModBlocks.QUARTZ_PILLAR)
            .criterion(hasItem(ModBlocks.QUARTZ_PILLAR), conditionsFromItem(ModBlocks.QUARTZ_PILLAR))
            .offerTo(exporter);
