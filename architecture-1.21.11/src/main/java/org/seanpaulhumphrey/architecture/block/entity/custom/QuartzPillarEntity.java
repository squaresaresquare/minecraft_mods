...
public class QuartzPillarEntity extends BlockEntity implements ImplementedInventory, ExtendedScreenHandlerFactory<@NotNull BlockPos> {
    ...
    public Text getDisplayName() {
        return Text.literal("QuartzPillar");
    }
