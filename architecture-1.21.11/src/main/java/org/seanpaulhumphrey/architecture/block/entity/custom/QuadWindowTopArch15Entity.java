...
public class QuadWindowTopArch15Entity extends BlockEntity implements ImplementedInventory, ExtendedScreenHandlerFactory<@NotNull BlockPos> {
    ...
    public Text getDisplayName() {
        return Text.literal("QuadWindowTopArch15");
    }
