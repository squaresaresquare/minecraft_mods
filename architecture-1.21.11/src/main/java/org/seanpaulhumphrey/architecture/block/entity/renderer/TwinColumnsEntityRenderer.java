...
public class TwinColumnsEntityRenderer implements BlockEntityRenderer<TwinColumnsEntity, BlockEntityRenderState> {
    private final ItemModelManager itemModelManager;

    public TwinColumnsEntityRenderer(BlockEntityRendererFactory.Context context) {
        itemModelManager = context.itemModelManager();
    }

    @Override
    public TwinColumnsEntityRenderState createRenderState() {
        return new TwinColumnsEntityRenderState();
    }
