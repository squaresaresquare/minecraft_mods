...
public class TripleWindowMiddleMiddleEntity extends BlockEntity implements ImplementedInventory, ExtendedScreenHandlerFactory<@NotNull BlockPos> {
    ...
    public TripleWindowMiddleMiddleEntity(BlockPos pos, BlockState state) {
    ...
    public Text getDisplayName() {
        return Text.literal("TripleWindowMiddleMiddle");
    }

    @Nullable
    @Override
    public ScreenHandler createMenu(int syncId, PlayerInventory playerInventory, PlayerEntity player) {
        return new TripleWindowMiddleMiddleScreenHandler(syncId, playerInventory, this.pos);
    }
