...
public class TwinColumnBaseEntityRenderer implements BlockEntityRenderer<TwinColumnBaseEntity, BlockEntityRenderState> {
    private final ItemModelManager itemModelManager;

    public TwinColumnBaseEntityRenderer(BlockEntityRendererFactory.Context context) {
        itemModelManager = context.itemModelManager();
    }

    @Override
    public TwinColumnBaseEntityRenderState createRenderState() {
        return new TwinColumnBaseEntityRenderState();
    }
