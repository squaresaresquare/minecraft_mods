...
public class QuadWindowTopArch24EntityRenderer implements BlockEntityRenderer<QuadWindowTopArch24Entity, BlockEntityRenderState> {
    private final ItemModelManager itemModelManager;

    public QuadWindowTopArch24EntityRenderer(BlockEntityRendererFactory.Context context) {
        itemModelManager = context.itemModelManager();
    }

    @Override
    public QuadWindowTopArch24EntityRenderState createRenderState() {
