...
public class ThinQuartzBaseEntityRenderer implements BlockEntityRenderer<ThinQuartzBaseEntity, BlockEntityRenderState> {
    private final ItemModelManager itemModelManager;

    public ThinQuartzBaseEntityRenderer(BlockEntityRendererFactory.Context context) {
        itemModelManager = context.itemModelManager();
    }

    @Override
    public ThinQuartzBaseEntityRenderState createRenderState() {
        return new ThinQuartzBaseEntityRenderState();
    }
