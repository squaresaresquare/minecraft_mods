package org.seanpaulhumphrey.architecture.screen.custom;
    ...
    public class QuadWindowTopArch26Screen extends HandledScreen<QuadWindowTopArch26ScreenHandler> {
        public static final Identifier GUI_TEXTURE =
                Identifier.of(Architecture.MOD_ID, "textures/gui/pillar/pillar_gui.png");

        public QuadWindowTopArch26Screen(QuadWindowTopArch26ScreenHandler handler, PlayerInventory inventory, Text title) {
