...
public class PillarScreen extends HandledScreen<PillarScreenHandler> {
    public static final Identifier GUI_TEXTURE =
            Identifier.of(Architecture.MOD_ID, "textures/gui/pillar/pillar_gui.png");

    public PillarScreen(PillarScreenHandler handler, PlayerInventory inventory, Text title) {
