package org.seanpaulhumphrey.architecture.screen.custom;
    ...
    public class TripleWindowMiddleMiddleScreen extends HandledScreen<TripleWindowMiddleMiddleScreenHandler> {
        public static final Identifier GUI_TEXTURE =
                Identifier.of(Architecture.MOD_ID, "textures/gui/pillar/pillar_gui.png");

        public TripleWindowMiddleMiddleScreen(TripleWindowMiddleMiddleScreenHandler handler, PlayerInventory inventory, Text title) {
