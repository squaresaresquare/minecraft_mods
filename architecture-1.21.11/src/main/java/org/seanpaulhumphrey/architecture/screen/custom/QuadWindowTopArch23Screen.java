package org.seanpaulhumphrey.architecture.screen.custom;
    ...
    public class QuadWindowTopArch23Screen extends HandledScreen<QuadWindowTopArch23ScreenHandler> {
        public static final Identifier GUI_TEXTURE =
                Identifier.of(Architecture.MOD_ID, "textures/gui/pillar/pillar_gui.png");

        public QuadWindowTopArch23Screen(QuadWindowTopArch23ScreenHandler handler, PlayerInventory inventory, Text title) {
