package org.seanpaulhumphrey.architecture.screen.custom;
    ...
    public class TwinColumnCapitalScreen extends HandledScreen<TwinColumnCapitalScreenHandler> {
        public static final Identifier GUI_TEXTURE =
                Identifier.of(Architecture.MOD_ID, "textures/gui/pillar/pillar_gui.png");

        public TwinColumnCapitalScreen(TwinColumnCapitalScreenHandler handler, PlayerInventory inventory, Text title) {
