package org.seanpaulhumphrey.architecture.screen.custom;
    ...
    public class TwinColumnsScreen extends HandledScreen<TwinColumnsScreenHandler> {
        public static final Identifier GUI_TEXTURE =
                Identifier.of(Architecture.MOD_ID, "textures/gui/pillar/pillar_gui.png");

        public TwinColumnsScreen(TwinColumnsScreenHandler handler, PlayerInventory inventory, Text title) {
