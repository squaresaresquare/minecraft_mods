...
public class ModScreenHandlers {
    ...
    public static final ScreenHandlerType<HalfPillarScreenHandler> HALF_PILLAR_SCREEN_HANDLER =
            Registry.register(Registries.SCREEN_HANDLER, Identifier.of(Architecture.MOD_ID, "half_pillar_screen_handler"),
                    new ExtendedScreenHandlerType<>(HalfPillarScreenHandler::new, BlockPos.PACKET_CODEC));
