package org.seanpaulhumphrey.architecture.screen.custom;
    ...
    public class TripleWindowMiddleBottomScreen extends HandledScreen<TripleWindowMiddleBottomScreenHandler> {
        public static final Identifier GUI_TEXTURE =
                Identifier.of(Architecture.MOD_ID, "textures/gui/pillar/pillar_gui.png");

        public TripleWindowMiddleBottomScreen(TripleWindowMiddleBottomScreenHandler handler, PlayerInventory inventory, Text title) {
