package org.seanpaulhumphrey.architecture.screen.custom;
    ...
    public class TripleWindowTopArchLeftScreen extends HandledScreen<TripleWindowTopArchLeftScreenHandler> {
        public static final Identifier GUI_TEXTURE =
                Identifier.of(Architecture.MOD_ID, "textures/gui/pillar/pillar_gui.png");

        public TripleWindowTopArchLeftScreen(TripleWindowTopArchLeftScreenHandler handler, PlayerInventory inventory, Text title) {
