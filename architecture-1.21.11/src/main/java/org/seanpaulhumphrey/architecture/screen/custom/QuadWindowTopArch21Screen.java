package org.seanpaulhumphrey.architecture.screen.custom;
    ...
    public class QuadWindowTopArch21Screen extends HandledScreen<QuadWindowTopArch21ScreenHandler> {
        public static final Identifier GUI_TEXTURE =
                Identifier.of(Architecture.MOD_ID, "textures/gui/pillar/pillar_gui.png");

        public QuadWindowTopArch21Screen(QuadWindowTopArch21ScreenHandler handler, PlayerInventory inventory, Text title) {
