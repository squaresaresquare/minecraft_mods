package org.seanpaulhumphrey.architecture.screen.custom;
    ...
    public class TwinColumnBaseScreen extends HandledScreen<TwinColumnBaseScreenHandler> {
        public static final Identifier GUI_TEXTURE =
                Identifier.of(Architecture.MOD_ID, "textures/gui/pillar/pillar_gui.png");

        public TwinColumnBaseScreen(TwinColumnBaseScreenHandler handler, PlayerInventory inventory, Text title) {
