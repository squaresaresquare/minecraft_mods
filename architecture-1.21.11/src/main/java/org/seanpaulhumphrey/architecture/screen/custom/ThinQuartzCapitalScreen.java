package org.seanpaulhumphrey.architecture.screen.custom;
    ...
    public class ThinQuartzCapitalScreen extends HandledScreen<ThinQuartzCapitalScreenHandler> {
        public static final Identifier GUI_TEXTURE =
                Identifier.of(Architecture.MOD_ID, "textures/gui/pillar/pillar_gui.png");

        public ThinQuartzCapitalScreen(ThinQuartzCapitalScreenHandler handler, PlayerInventory inventory, Text title) {
