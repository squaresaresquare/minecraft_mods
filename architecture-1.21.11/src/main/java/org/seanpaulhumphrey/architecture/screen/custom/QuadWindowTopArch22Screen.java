package org.seanpaulhumphrey.architecture.screen.custom;
    ...
    public class QuadWindowTopArch22Screen extends HandledScreen<QuadWindowTopArch22ScreenHandler> {
        public static final Identifier GUI_TEXTURE =
                Identifier.of(Architecture.MOD_ID, "textures/gui/pillar/pillar_gui.png");

        public QuadWindowTopArch22Screen(QuadWindowTopArch22ScreenHandler handler, PlayerInventory inventory, Text title) {
