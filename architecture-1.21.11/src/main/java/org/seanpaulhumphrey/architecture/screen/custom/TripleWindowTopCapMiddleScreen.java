package org.seanpaulhumphrey.architecture.screen.custom;
    ...
    public class TripleWindowTopCapMiddleScreen extends HandledScreen<TripleWindowTopCapMiddleScreenHandler> {
        public static final Identifier GUI_TEXTURE =
                Identifier.of(Architecture.MOD_ID, "textures/gui/pillar/pillar_gui.png");

        public TripleWindowTopCapMiddleScreen(TripleWindowTopCapMiddleScreenHandler handler, PlayerInventory inventory, Text title) {
