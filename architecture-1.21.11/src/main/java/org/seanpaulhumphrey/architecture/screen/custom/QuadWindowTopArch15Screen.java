package org.seanpaulhumphrey.architecture.screen.custom;
    ...
    public class QuadWindowTopArch15Screen extends HandledScreen<QuadWindowTopArch15ScreenHandler> {
        public static final Identifier GUI_TEXTURE =
                Identifier.of(Architecture.MOD_ID, "textures/gui/pillar/pillar_gui.png");

        public QuadWindowTopArch15Screen(QuadWindowTopArch15ScreenHandler handler, PlayerInventory inventory, Text title) {
