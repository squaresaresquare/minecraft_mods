package org.seanpaulhumphrey.architecture.screen.custom;
    ...
    public class TripleWindowTopArch23Screen extends HandledScreen<TripleWindowTopArch23ScreenHandler> {
        public static final Identifier GUI_TEXTURE =
                Identifier.of(Architecture.MOD_ID, "textures/gui/pillar/pillar_gui.png");

        public TripleWindowTopArch23Screen(TripleWindowTopArch23ScreenHandler handler, PlayerInventory inventory, Text title) {
