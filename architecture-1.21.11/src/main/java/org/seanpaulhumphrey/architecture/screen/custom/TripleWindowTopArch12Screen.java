package org.seanpaulhumphrey.architecture.screen.custom;
    ...
    public class TripleWindowTopArch12Screen extends HandledScreen<TripleWindowTopArch12ScreenHandler> {
        public static final Identifier GUI_TEXTURE =
                Identifier.of(Architecture.MOD_ID, "textures/gui/pillar/pillar_gui.png");

        public TripleWindowTopArch12Screen(TripleWindowTopArch12ScreenHandler handler, PlayerInventory inventory, Text title) {
