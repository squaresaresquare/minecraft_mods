package org.seanpaulhumphrey.architecture.screen.custom;
    ...
    public class TripleWindowTopArch22Screen extends HandledScreen<TripleWindowTopArch22ScreenHandler> {
        public static final Identifier GUI_TEXTURE =
                Identifier.of(Architecture.MOD_ID, "textures/gui/pillar/pillar_gui.png");

        public TripleWindowTopArch22Screen(TripleWindowTopArch22ScreenHandler handler, PlayerInventory inventory, Text title) {
