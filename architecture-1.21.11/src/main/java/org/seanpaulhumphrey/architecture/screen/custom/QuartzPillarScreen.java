package org.seanpaulhumphrey.architecture.screen.custom;
    ...
    public class QuartzPillarScreen extends HandledScreen<QuartzPillarScreenHandler> {
        public static final Identifier GUI_TEXTURE =
                Identifier.of(Architecture.MOD_ID, "textures/gui/pillar/pillar_gui.png");

        public QuartzPillarScreen(QuartzPillarScreenHandler handler, PlayerInventory inventory, Text title) {
