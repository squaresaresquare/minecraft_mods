package org.seanpaulhumphrey.architecture.screen.custom;
    ...
    public class HalfQuartzPillarScreen extends HandledScreen<HalfQuartzPillarScreenHandler> {
        public static final Identifier GUI_TEXTURE =
                Identifier.of(Architecture.MOD_ID, "textures/gui/pillar/pillar_gui.png");

        public HalfQuartzPillarScreen(HalfQuartzPillarScreenHandler handler, PlayerInventory inventory, Text title) {
