package org.seanpaulhumphrey.architecture.screen.custom;
    ...
    public class TripleWindowMiddleLeftScreen extends HandledScreen<TripleWindowMiddleLeftScreenHandler> {
        public static final Identifier GUI_TEXTURE =
                Identifier.of(Architecture.MOD_ID, "textures/gui/pillar/pillar_gui.png");

        public TripleWindowMiddleLeftScreen(TripleWindowMiddleLeftScreenHandler handler, PlayerInventory inventory, Text title) {
