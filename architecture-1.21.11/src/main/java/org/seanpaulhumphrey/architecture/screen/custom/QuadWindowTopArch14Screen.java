package org.seanpaulhumphrey.architecture.screen.custom;
    ...
    public class QuadWindowTopArch14Screen extends HandledScreen<QuadWindowTopArch14ScreenHandler> {
        public static final Identifier GUI_TEXTURE =
                Identifier.of(Architecture.MOD_ID, "textures/gui/pillar/pillar_gui.png");

        public QuadWindowTopArch14Screen(QuadWindowTopArch14ScreenHandler handler, PlayerInventory inventory, Text title) {
