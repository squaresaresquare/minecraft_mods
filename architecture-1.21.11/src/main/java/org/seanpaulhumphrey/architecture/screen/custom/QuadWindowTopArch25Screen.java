package org.seanpaulhumphrey.architecture.screen.custom;
    ...
    public class QuadWindowTopArch25Screen extends HandledScreen<QuadWindowTopArch25ScreenHandler> {
        public static final Identifier GUI_TEXTURE =
                Identifier.of(Architecture.MOD_ID, "textures/gui/pillar/pillar_gui.png");

        public QuadWindowTopArch25Screen(QuadWindowTopArch25ScreenHandler handler, PlayerInventory inventory, Text title) {
