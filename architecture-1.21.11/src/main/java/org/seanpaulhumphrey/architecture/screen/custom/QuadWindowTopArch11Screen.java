package org.seanpaulhumphrey.architecture.screen.custom;
    ...
    public class QuadWindowTopArch11Screen extends HandledScreen<QuadWindowTopArch11ScreenHandler> {
        public static final Identifier GUI_TEXTURE =
                Identifier.of(Architecture.MOD_ID, "textures/gui/pillar/pillar_gui.png");

        public QuadWindowTopArch11Screen(QuadWindowTopArch11ScreenHandler handler, PlayerInventory inventory, Text title) {
