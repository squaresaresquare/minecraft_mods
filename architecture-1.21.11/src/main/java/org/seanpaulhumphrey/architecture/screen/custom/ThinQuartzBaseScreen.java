package org.seanpaulhumphrey.architecture.screen.custom;
    ...
    public class ThinQuartzBaseScreen extends HandledScreen<ThinQuartzBaseScreenHandler> {
        public static final Identifier GUI_TEXTURE =
                Identifier.of(Architecture.MOD_ID, "textures/gui/pillar/pillar_gui.png");

        public ThinQuartzBaseScreen(ThinQuartzBaseScreenHandler handler, PlayerInventory inventory, Text title) {
