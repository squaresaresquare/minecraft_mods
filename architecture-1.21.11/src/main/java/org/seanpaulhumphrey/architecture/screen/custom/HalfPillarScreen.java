...
public class HalfPillarScreen extends HandledScreen<HalfPillarScreenHandler> {
    public static final Identifier GUI_TEXTURE =
            Identifier.of(Architecture.MOD_ID, "textures/gui/pillar/pillar_gui.png");

    public HalfPillarScreen(HalfPillarScreenHandler handler, PlayerInventory inventory, Text title) {
