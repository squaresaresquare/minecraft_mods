package org.seanpaulhumphrey.architecture.screen.custom;
    ...
    public class TripleWindowTopCapRightScreen extends HandledScreen<TripleWindowTopCapRightScreenHandler> {
        public static final Identifier GUI_TEXTURE =
                Identifier.of(Architecture.MOD_ID, "textures/gui/pillar/pillar_gui.png");

        public TripleWindowTopCapRightScreen(TripleWindowTopCapRightScreenHandler handler, PlayerInventory inventory, Text title) {
