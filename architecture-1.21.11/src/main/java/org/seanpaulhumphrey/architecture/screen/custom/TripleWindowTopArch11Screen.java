package org.seanpaulhumphrey.architecture.screen.custom;
    ...
    public class TripleWindowTopArch11Screen extends HandledScreen<TripleWindowTopArch11ScreenHandler> {
        public static final Identifier GUI_TEXTURE =
                Identifier.of(Architecture.MOD_ID, "textures/gui/pillar/pillar_gui.png");

        public TripleWindowTopArch11Screen(TripleWindowTopArch11ScreenHandler handler, PlayerInventory inventory, Text title) {
