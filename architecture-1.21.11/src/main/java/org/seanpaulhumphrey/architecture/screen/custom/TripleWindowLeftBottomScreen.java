package org.seanpaulhumphrey.architecture.screen.custom;
    ...
    public class TripleWindowLeftBottomScreen extends HandledScreen<TripleWindowLeftBottomScreenHandler> {
        public static final Identifier GUI_TEXTURE =
                Identifier.of(Architecture.MOD_ID, "textures/gui/pillar/pillar_gui.png");

        public TripleWindowLeftBottomScreen(TripleWindowLeftBottomScreenHandler handler, PlayerInventory inventory, Text title) {
