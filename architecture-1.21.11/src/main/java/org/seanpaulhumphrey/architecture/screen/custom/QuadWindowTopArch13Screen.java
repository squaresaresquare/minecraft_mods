package org.seanpaulhumphrey.architecture.screen.custom;
    ...
    public class QuadWindowTopArch13Screen extends HandledScreen<QuadWindowTopArch13ScreenHandler> {
        public static final Identifier GUI_TEXTURE =
                Identifier.of(Architecture.MOD_ID, "textures/gui/pillar/pillar_gui.png");

        public QuadWindowTopArch13Screen(QuadWindowTopArch13ScreenHandler handler, PlayerInventory inventory, Text title) {
