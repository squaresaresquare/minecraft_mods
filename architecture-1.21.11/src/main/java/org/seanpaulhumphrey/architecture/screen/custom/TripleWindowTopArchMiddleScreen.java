package org.seanpaulhumphrey.architecture.screen.custom;
    ...
    public class TripleWindowTopArchMiddleScreen extends HandledScreen<TripleWindowTopArchMiddleScreenHandler> {
        public static final Identifier GUI_TEXTURE =
                Identifier.of(Architecture.MOD_ID, "textures/gui/pillar/pillar_gui.png");

        public TripleWindowTopArchMiddleScreen(TripleWindowTopArchMiddleScreenHandler handler, PlayerInventory inventory, Text title) {
