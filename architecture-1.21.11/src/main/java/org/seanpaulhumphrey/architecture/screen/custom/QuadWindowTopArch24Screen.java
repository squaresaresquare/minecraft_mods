package org.seanpaulhumphrey.architecture.screen.custom;
    ...
    public class QuadWindowTopArch24Screen extends HandledScreen<QuadWindowTopArch24ScreenHandler> {
        public static final Identifier GUI_TEXTURE =
                Identifier.of(Architecture.MOD_ID, "textures/gui/pillar/pillar_gui.png");

        public QuadWindowTopArch24Screen(QuadWindowTopArch24ScreenHandler handler, PlayerInventory inventory, Text title) {
