package org.seanpaulhumphrey.architecture.screen.custom;
    ...
    public class TripleWindowTopArch13Screen extends HandledScreen<TripleWindowTopArch13ScreenHandler> {
        public static final Identifier GUI_TEXTURE =
                Identifier.of(Architecture.MOD_ID, "textures/gui/pillar/pillar_gui.png");

        public TripleWindowTopArch13Screen(TripleWindowTopArch13ScreenHandler handler, PlayerInventory inventory, Text title) {
