package org.seanpaulhumphrey.architecture.screen.custom;
        ...
        public class QuartzPillarScreenHandler extends ScreenHandler {
            private final Inventory inventory;

            public QuartzPillarScreenHandler(int syncId, PlayerInventory playerInventory, BlockPos pos) {
                this(syncId, playerInventory, playerInventory.player.getEntityWorld().getBlockEntity(pos));
        }

        public QuartzPillarScreenHandler(int syncId, PlayerInventory playerInventory, BlockEntity blockEntity) {
