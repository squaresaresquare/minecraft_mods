package org.seanpaulhumphrey.architecture.screen.custom;
    ...
    public class TripleWindowRightBottomScreen extends HandledScreen<TripleWindowRightBottomScreenHandler> {
        public static final Identifier GUI_TEXTURE =
                Identifier.of(Architecture.MOD_ID, "textures/gui/pillar/pillar_gui.png");

        public TripleWindowRightBottomScreen(TripleWindowRightBottomScreenHandler handler, PlayerInventory inventory, Text title) {
