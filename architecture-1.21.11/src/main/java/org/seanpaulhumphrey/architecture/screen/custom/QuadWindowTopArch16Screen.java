package org.seanpaulhumphrey.architecture.screen.custom;
    ...
    public class QuadWindowTopArch16Screen extends HandledScreen<QuadWindowTopArch16ScreenHandler> {
        public static final Identifier GUI_TEXTURE =
                Identifier.of(Architecture.MOD_ID, "textures/gui/pillar/pillar_gui.png");

        public QuadWindowTopArch16Screen(QuadWindowTopArch16ScreenHandler handler, PlayerInventory inventory, Text title) {
