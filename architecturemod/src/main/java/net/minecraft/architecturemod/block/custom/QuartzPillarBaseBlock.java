...
public class QuartzPillarBaseBlock extends BaseEntityBlock {
    ...
    public QuartzPillarBaseBlock(Properties settings) {
        super(settings);
    }

    @Override
    protected MapCodec<? extends BaseEntityBlock> codec() {
        return simpleCodec(QuartzPillarBaseBlock::new);
    }
