...
public class QuadWindowTopArch12Block extends BaseEntityBlock {
    ...
    public QuadWindowTopArch12Block(Properties settings) {
        super(settings);
    }

    @Override
    protected MapCodec<? extends BaseEntityBlock> codec() {
        return simpleCodec(QuadWindowTopArch12Block::new);
    }

    @Nullable
    @Override
    public BlockEntity newBlockEntity(BlockPos pos, BlockState state) {
        return new QuadWindowTopArch12BlockEntity(pos, state);
    }
